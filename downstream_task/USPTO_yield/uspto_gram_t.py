...
def get_args():
    ...
    parser.add_argument('--learning_rate', 
                        default=7.447849724281584e-05, 
                        help="learning rate", 
                        type=float)
    parser.add_argument('--hidden_dropout_prob', 
                        default=0.011009942873200881, 
                        help="dropout rate", 
                        type=float)
    parser.add_argument('--model_path', 
                        default='../../outputs/egret_pretrain_stage_1_t/bestoutput_t', 
                        help="model path", 
                        type=str)    
...
if __name__ == '__main__':
    ...
    trn_df = pd.read_csv(os.path.abspath('../../dataset/source_dataset/USPTO_yield_t/USPTO_gram_train_t.csv'), encoding='utf-8')
    val_df = pd.read_csv(os.path.abspath('../../dataset/source_dataset/USPTO_yield_t/USPTO_gram_val_t.csv'), encoding='utf-8')
    test_df = pd.read_csv(os.path.abspath('../../dataset/source_dataset/USPTO_yield_t/USPTO_gram_test_t.tsv'), sep='\t', index_col=0)
    ...
    'manual_seed': 42,
    "output_dir": f"../../outputs/uspto_gram/out",
    'best_model_dir': f"../../outputs/uspto_gram/best_out",
    "max_seq_length": 300, 
    "train_batch_size": 16,
    "warmup_ratio": 0.00,
