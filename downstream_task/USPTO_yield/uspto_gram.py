...
def get_args():
    ...
    parser.add_argument('--model_path', 
                        default='../../outputs/egret_pretrain_stage_1/bestoutput', 
                        help="model path", 
                        type=str)    
...
if __name__ == '__main__':
    ...
    test_df = pd.read_csv(os.path.abspath('../../dataset/source_dataset/USPTO_yield/gram_test_random_split.tsv'), sep='\t', index_col=0)
